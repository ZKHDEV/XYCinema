    ...
    <div>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="list-group">
                            ...
                            <p class="list-group-item active">修改资料</p>
                ...
                <div class="col-md-9">
                    <form id="msgform" action="/cinema/Home/User/changemsg" method="post" class="form-horizontal col-md-4 col-md-offset-1" autocomplete="off">
                        <br/>
                        <div class="form-group">
                            <label for="u_name">用户名</label>
                            <input type="text" class="form-control" name="u_name" id="u_name" maxlength="10" value="<?php echo ($user["u_name"]); ?>">
                        </div>
                        <div class="form-group">
                            <label for="u_email">邮箱</label>
                            <input type="text" class="form-control" name="u_email" id="u_email" value="<?php echo ($user["u_email"]); ?>">
                        </div>
                        <br/>
                        <div class="form-group">
