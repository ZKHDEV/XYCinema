    ...
    <div style="background-color:#ffffff;padding-left: 30px;padding-right: 30px">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                ...
                <form id="noticeform" action="/cinema/Admin/Notice/add" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <textarea class="span9 wysihtml5 m-wrap" rows="50" name="n_content"></textarea>
