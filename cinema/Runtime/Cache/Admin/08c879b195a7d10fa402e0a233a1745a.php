    ...
    <div style="background-color:#ffffff;padding-left: 30px;padding-right: 30px">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                ...
                <form id="changeform" action="/cinema/Admin/Manager/changepwd/a_id/1" method="post" class="form-horizontal" onsubmit="return checkchange();">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input id="p_pwd2" type="password" class="m-wrap" name="p_pwd2" maxlength="20"/>
                            <input id="p_pwd" type="hidden" name="p_pwd">
                            <?php if(!empty($error["p_pwd"])): ?><span class="help-inline"><?php echo ($error["p_pwd"]); ?></span><?php endif; ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input id="a_pwd2" type="password" class="m-wrap" name="a_pwd2" maxlength="20"/>
                            <input id="a_pwd" type="hidden" name="a_pwd">
                            <?php if(!empty($error["a_pwd"])): ?><span class="help-inline"><?php echo ($error["a_pwd"]); ?></span><?php endif; ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input id="r_pwd2" type="password" class="m-wrap" name="r_pwd2" maxlength="20"/>
                            <input id="r_pwd" type="hidden" name="r_pwd">
                            <?php if(!empty($error["r_pwd"])): ?><span class="help-inline"><?php echo ($error["r_pwd"]); ?></span><?php endif; ?>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="/cinema/Admin/Manager/index" type="button" class="btn">取消</a>
...
<script>
    ...
    <script src="<?php echo (ADMIN_JS_URL); ?>/jquery.md5.js"></script>
    ...
    <script>
        ...
        function checkchange() {
            $("#p_pwd").val($.md5($('#p_pwd2').val()));
            $("#a_pwd").val($.md5($('#a_pwd2').val()));
