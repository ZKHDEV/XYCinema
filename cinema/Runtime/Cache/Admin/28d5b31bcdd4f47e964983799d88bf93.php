    ...
    <div style="background-color:#ffffff;padding-left: 30px;padding-right: 30px">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                ...
                <form id="movieaddform" action="/cinema/Admin/Movie/add" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return checkUpload()">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="m-wrap" name="m_name" maxlength="60"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="m-wrap" name="m_director" maxlength="40"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="m-wrap" name="m_star" maxlength="100"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="hidden" id="typeselect" class="select2" style="width: 220px"  name="m_type">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="m-wrap" name="m_language" maxlength="25"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="m-wrap" name="m_version" maxlength="10"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <div class="input-append date date-picker"  data-date="102/2012" data-date-format="mm/dd/yyyy" data-date-viewmode="years" data-date-minviewmode="months">
                                ...
                                <input class="m-wrap m-ctrl-medium date-picker" readonly size="16" type="text" name="m_showdate"/><span class="add-on"><i class="icon-calendar"></i></span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <div class="input-append bootstrap-timepicker-component">
                                ...
                                <input class="m-wrap m-ctrl-small timepicker-24" readonly type="text" name="m_length"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <textarea class="m-wrap" rows="3" name="m_descride"></textarea>
                        ...
                        <div class="controls">
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <div>
                                    ...
                                    <input type="file" id="frontcover" class="default" name="m_frontcover" accept="image/jpeg,image/gif,image/png"/></span>
                        ...
                        <div class="controls">
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <div>
													...
													<input type="file" id="poster" class="default" name="m_poster" accept="image/jpeg,image/gif,image/png"/></span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="m-wrap" name="m_advance"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <label class="radio">
                                ...
                                <input type="radio" name="m_ishot" value="1"/>
                            ...
                            <label class="radio">
                                ...
                                <input type="radio" name="m_ishot" value="0" checked />
