    ...
    <div style="background-color:#ffffff;padding-left: 30px;padding-right: 30px">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                ...
                <form id="roomform" action="/cinema/Admin/Cinema/ediroom/c_id/3/r_id/10" method="post" class="form-horizontal">

                    <input type="hidden" name="r_cinemaid" value="<?php echo ($c_id); ?>">
                    <input type="hidden" name="r_subtime" value="<?php echo ($room["r_subtime"]); ?>">
                    <input type="hidden" name="r_delflag" value="<?php echo ($room["r_delflag"]); ?>">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="m-wrap" name="r_name" value="<?php echo ($room["r_name"]); ?>" maxlength="50"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input id="seatnum" class="span6 m-wrap" type="text" value="<?php echo ($room["r_count"]); ?>" disabled />
                            <input type="hidden" id="seats" name="r_seats" value="<?php echo ($room["r_seats"]); ?>">
                    ...
                    <div class="seatdiv">
                        <?php $__FOR_START_474__=1;$__FOR_END_474__=12;for($row=$__FOR_START_474__;$row < $__FOR_END_474__;$row+=1){ ?><ul class="seatlist">
                                <?php $__FOR_START_26123__=1;$__FOR_END_26123__=15;for($col=$__FOR_START_26123__;$col < $__FOR_END_26123__;$col+=1){ $n = $row*14-14+$col; $url = ADMIN_IMG_URL; if(in_array($row*14-14+$col,$room['seats'])) echo "<li><a href='javascript:void(0)' class='seatlink' num='$n' sel='1'><img src='$url/sseat.png'/></a></li>"; else echo "<li><a href='javascript:void(0)' class='seatlink' num='$n' sel='0'><img src='$url/eseat.png'/></a></li>"; } ?>
