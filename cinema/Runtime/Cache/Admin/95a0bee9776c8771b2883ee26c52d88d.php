    ...
    <div style="background-color:#ffffff;padding-left: 30px;padding-right: 30px">
        ...
        <div class="clearfix">
            ...
            <div class="btn-group">
                ...
                <a class="btn green" href="/cinema/Admin/Movie/add">
        ...
        <div>
            ...
            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <?php if(is_array($info)): foreach($info as $key=>$movie): ?><tr>

                        <td><?php echo ($movie["m_name"]); ?></td>

                        <td><?php echo ($movie["m_type"]); ?></td>

                        <td><?php echo ($movie["m_country"]); ?></td>

                        <td><?php echo ($movie["m_language"]); ?></td>

                        <td><?php echo ($movie["m_length"]); ?></td>

                        <td>
                            <?php if($movie["m_ishot"] == 1): ?>是
                                <?php else: ?>否<?php endif; ?>
                        </td>

                        <td><a href="/cinema/Admin/Movie/stage/m_id/<?php echo ($movie["m_id"]); ?>">剧照</a></td>

                        <td><a href="/cinema/Admin/Movie/detail/m_id/<?php echo ($movie["m_id"]); ?>">详情</a></td>

                        <td><a href="/cinema/Admin/Movie/update/m_id/<?php echo ($movie["m_id"]); ?>">修改</a></td>

                        <td><a href="/cinema/Admin/Movie/delete/m_id/<?php echo ($movie["m_id"]); ?>" onclick="return confirm('确定要删除吗？');">删除</a></td>
