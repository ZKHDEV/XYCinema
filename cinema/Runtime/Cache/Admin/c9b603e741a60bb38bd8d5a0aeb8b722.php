    ...
    <div style="background-color:#ffffff;padding-left: 30px;padding-right: 30px">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                ...
                <form id="noticeform" action="/cinema/Admin/Notice/update" method="post" class="form-horizontal">

                    <input type="hidden" name="n_id" value="<?php echo ($notice["n_id"]); ?>">
                    <input type="hidden" name="n_delflag" value="<?php echo ($notice["n_delflag"]); ?>">
                    <input type="hidden" name="n_subtime" value="<?php echo ($notice["n_subtime"]); ?>">
                    <input type="hidden" name="n_isshow" value="<?php echo ($notice["n_isshow"]); ?>">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <textarea class="span9 wysihtml5 m-wrap" rows="50" name="n_content"><?php echo ($notice["n_content"]); ?></textarea>

                            <?php if(!empty($error["n_content"])): ?><span class="help-inline"><?php echo ($error["n_content"]); ?></span><?php endif; ?>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="/cinema/Admin/Notice/index" type="button" class="btn">取消</a>
